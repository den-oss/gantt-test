...
class GntProcesser extends EventEmitter {
	constructor(opts, workerId = -1, workerProcess = null) {
		...
		let defOpts = {
			filePath: './gantt-app/build/production/CGA/index.html',
		...
		//this.opts.fileUrl = 'file://' + __dirname + '/gantt-app/build/production/CGA/index.html' + this.opts.appQuery;
	...
	*/
	...
	run (cmdOpts) {
	    ...
	    if (1) {
			...
			var codeJquery = fs.readFileSync("gantt-app/build/production/CGA/js/jquery.min.js");
			var scriptJquery = new vm.Script(codeJquery);
			var codeForcetk = fs.readFileSync("gantt-app/build/production/CGA/js/forcetk.js");
			var scriptForcetk = new vm.Script(codeForcetk);
			var codeBootstrap = fs.readFileSync("gantt-app/build/production/CGA/bootstrap.js");
			var codeApp = fs.readFileSync("gantt-app/build/production/CGA/classic/app.js");
